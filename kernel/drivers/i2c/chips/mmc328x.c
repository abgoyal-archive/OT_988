...
#define MMC328X_DELAY_TM	12	/* ms */
#define MMC328X_DELAY_RM	12	/* ms */
	...
	unsigned int cmd, unsigned long arg)
{
	...
	//printk(" -- here is mmc328x_ioctl leesh = %d ---\n", cmd);
	...
	#if DEBUG
		printk("here is mmc328x_ioctl leesh");
	...
	case MMC328X_IOC_READXYZ:
		...
		if(1){//leesh if (!(read_idx % MMC328X_RESET_INTV)) {
			/* RM */
			data[0] = MMC328X_REG_CTRL;
			data[1] = MMC328X_CTRL_RM | MMC328X_CTRL_NOBOOST;
