...
#define TAOS_IOCTL_PROX_DATA		_IOR(TAOS_IOCTL_MAGIC, 9, taos_prox_info)
...
//add leesh 20110411 ->
#define TAOS_IOCTL_ALS_ON_EXEC       	_IO(TAOS_IOCTL_MAGIC, 17)
#define TAOS_IOCTL_ALS_OFF_EXEC      	_IO(TAOS_IOCTL_MAGIC, 18)

#define TAOS_IOCTL_PROX_ON_EXEC		_IO(TAOS_IOCTL_MAGIC, 19)
#define TAOS_IOCTL_PROX_OFF_EXEC		_IO(TAOS_IOCTL_MAGIC, 20)
//add leesh 20110411 <-
