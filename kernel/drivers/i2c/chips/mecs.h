...
#define ECOMPASS_IOC_SET_YPR		_IOW(ECOMPASS_IOM, 0x30, int[14])

#define ECOMPASS_IOC_SET_PPARMS		_IOW(ECOMPASS_IOM, 0x31, uint16_t)
#define ECOMPASS_IOC_GET_PPARMS		_IOR(ECOMPASS_IOM, 0x32, uint16_t)
#define ECOMPASS_IOC_SET_LPARMS		_IOW(ECOMPASS_IOM, 0x33, uint16_t)
#define ECOMPASS_IOC_GET_LPARMS		_IOR(ECOMPASS_IOM, 0x34, uint16_t)
