...
*                       01/06/2011--disable als function
*                                                                              *
********************************************************************************
...
static int taos_prox_poll(struct taos_prox_info *prxp)
{
    //printk("Jiaxing Wang ---- taos_prox_poll()\n");
	static int event = 0;
	u16 status = 0;
...
{
	int ret = 0;
    //printk("Jiaxing Wang ----- taos_prox_work_f()\n");
	...
	if (prox_on) {
		...
		/*printk("Jiaxing Wang XXXXXXXXXXXXX prox->event == %d XXXXXXXXX\n", prox_cur_infop->prox_event);  */
	}
	else
