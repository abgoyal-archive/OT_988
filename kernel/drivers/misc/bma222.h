...
/** bma222 I2C Address
*/ 
#define BMA222_I2C_ADDR                0x08//  0x18
/*
...
typedef struct  {
	bma222regs_t * image;
			   /**< pointer to bma222regs_t structure not mandatory */
	unsigned char mode;
			   /**< save current bma222 operation mode */
	 ...
	 unsigned char dev_addr;
			     /**< initializes bma222's I2C device address 0x38 */
	 unsigned char int_mask;
			     /**< stores the current bma222 API generated interrupt mask */
	 ...
	 void (*delay_msec) (bma222_MDELAY_DATA_TYPE);
...
#define bma222_SET_BITSLICE(regvar, bitname, val)\
     (regvar & ~bitname                          \
##__MSK) | ((val<<bitname##__POS)&bitname##__MSK)
 ...
 */
#define BMA222_INSTALL_DIR		4    //3//3 is error,venurs shuld be 7  from memsicd ,now in aeans project,not it should be 5
...
/* EasyCASE ) */ 
/* EasyCASE ) */ 
void coordinate_real_to_android(bma222acc_t * acc, int dir);
#endif	/*  */
/* EasyCASE ) */ 
