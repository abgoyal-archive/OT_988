...
{
	return socinfo ?
		(socinfo->v1.format >= 9 ? socinfo->v9.hw_id : 0)
		: 0;
}
...
{
	return socinfo ?
		(socinfo->v1.format >= 9 ? socinfo->v9.carrier_id : 0)
		: 0;
}
...
{
	return socinfo ?
		(socinfo->v1.format >= 9 ? socinfo->v9.npi_mode : 0)
		: 0;
}
#endif	//	CONFIG_M7LAB_JUKE_USB
#endif	//	CONFIG_M7LAB_VENUS
...
int __init socinfo_init(void)
{
	...
	case 5:
		...
		break;
#ifdef CONFIG_M7LAB_VENUS	//	Teddy 2011-01-19
	case 9:
		pr_info("%s: v%u, id=%u, ver=%u.%u, "
			 "raw_id=%u, raw_ver=%u, hw_plat=%u, hw_plat_ver=%u\n",
			__func__, socinfo->v1.format, socinfo->v1.id,
			...
			socinfo->v2.raw_id, socinfo->v2.raw_version,
			socinfo->v3.hw_platform, socinfo->v4.platform_version);
		pr_info("%s: hw_id=0x%x, hw_carrier_id=%u, hw_id_raw=%u\n",
			__func__,
			socinfo->v9.hw_id, socinfo->v9.carrier_id, socinfo->v9.raw);
		break;
#endif	//	CONFIG_M7LAB_VENUS
	default:
