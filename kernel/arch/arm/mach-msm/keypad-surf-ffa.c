...
#ifdef CONFIG_M7LAB_VENUS_KEY	//	Teddy 2011-01-20
/* Modified by yubin,  for aeneas, begin */
//static unsigned int keypad_row_gpios[] = { 35, 34, 33, 32, 31, 30, 29, 28 };
//static unsigned int keypad_col_gpios[] = { 36, 37, 38, 39, 40, 41 };
static unsigned int keypad_row_gpios[] = { 28 };
static unsigned int keypad_col_gpios[] = { 39, 40 };
/* Modified by yubin,  for aeneas, end */
#else
...
/* Modified by yubin,  for aeneas, begin */
	...
	[KEYMAP_INDEX(0, 1)] = KEY_MENU,			/*	SOFT1	*/
	[KEYMAP_INDEX(0, 2)] = KEY_HOME,			/*	SOFT2	*/
	[KEYMAP_INDEX(0, 3)] = KEY_SEARCH,
	[KEYMAP_INDEX(0, 4)] = KEY_O,
	[KEYMAP_INDEX(0, 5)] = KEY_BACK,

	[KEYMAP_INDEX(1, 0)] = KEY_Q,
	[KEYMAP_INDEX(1, 1)] = KEY_E,
	[KEYMAP_INDEX(1, 2)] = KEY_Y,
	[KEYMAP_INDEX(1, 3)] = KEY_J,
	[KEYMAP_INDEX(1, 4)] = KEY_ENTER,
	[KEYMAP_INDEX(1, 5)] = KEY_K,

	[KEYMAP_INDEX(2, 0)] = KEY_W,
	[KEYMAP_INDEX(2, 1)] = KEY_R,
	[KEYMAP_INDEX(2, 2)] = KEY_T,
	[KEYMAP_INDEX(2, 3)] = KEY_U,
	[KEYMAP_INDEX(2, 4)] = KEY_P,
	[KEYMAP_INDEX(2, 5)] = KEY_I,

	[KEYMAP_INDEX(3, 0)] = KEY_A,
	[KEYMAP_INDEX(3, 1)] = KEY_D,
	[KEYMAP_INDEX(3, 2)] = KEY_F,
	[KEYMAP_INDEX(3, 3)] = KEY_G,
	[KEYMAP_INDEX(3, 4)] = KEY_DELETE,
	[KEYMAP_INDEX(3, 5)] = KEY_L,

	[KEYMAP_INDEX(4, 0)] = KEY_S,
	[KEYMAP_INDEX(4, 1)] = KEY_Z,
	[KEYMAP_INDEX(4, 2)] = KEY_H,
	[KEYMAP_INDEX(4, 3)] = KEY_B,
	[KEYMAP_INDEX(4, 4)] = KEY_COMPOSE,
	[KEYMAP_INDEX(4, 5)] = KEY_N,

	[KEYMAP_INDEX(5, 0)] = KEY_LEFTSHIFT,
	[KEYMAP_INDEX(5, 1)] = KEY_X,
	[KEYMAP_INDEX(5, 2)] = KEY_C,
	[KEYMAP_INDEX(5, 3)] = KEY_V,
	[KEYMAP_INDEX(5, 4)] = KEY_QUESTION,
	[KEYMAP_INDEX(5, 5)] = KEY_DOT,

	[KEYMAP_INDEX(6, 0)] = KEY_FN,
	[KEYMAP_INDEX(6, 1)] = KEY_EMAIL,
	[KEYMAP_INDEX(6, 2)] = KEY_COMMA,
	[KEYMAP_INDEX(6, 3)] = KEY_SPACE,
	[KEYMAP_INDEX(6, 4)] = 250,	//	PICTSYMBOL
	[KEYMAP_INDEX(6, 5)] = KEY_M,

	[KEYMAP_INDEX(7, 0)] = KEY_UP,				//	Teddy 2011-10-17
	[KEYMAP_INDEX(7, 1)] = KEY_LEFT,			//	Teddy 2011-10-17
	[KEYMAP_INDEX(7, 2)] = KEY_RIGHT,			//	Teddy 2011-10-17
	[KEYMAP_INDEX(7, 3)] = KEY_VOLUMEUP,
	[KEYMAP_INDEX(7, 4)] = KEY_VOLUMEDOWN,
	[KEYMAP_INDEX(7, 5)] = KEY_DOWN,			//	Teddy 2011-10-17
#endif
/* Modified by yubin,  for aeneas, end */
};
#else
...
static struct gpio_event_matrix_info surf_keypad_matrix_info = {
	...
	.flags		= GPIOKPF_LEVEL_TRIGGERED_IRQ |
			  GPIOKPF_PRINT_UNMAPPED_KEYS
			   | GPIOKPF_REMOVE_PHANTOM_KEYS	//	Teddy 2011-04-26
};
