						 ...
						 struct wpa_interface *iface)
{
	...
	property_set("wifi.wpa_supp_ready", "1"); //11.08.23, jclee@gtsystem.co.kr fixed status, refer to codeaurora
				...
				struct wpa_supplicant *wpa_s)
{
	...
	property_set("wifi.wpa_supp_ready", "0"); //11.08.23, jclee@gtsystem.co.kr fixed status, refer to codeaurora
