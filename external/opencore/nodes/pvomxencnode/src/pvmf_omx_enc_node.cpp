...
bool PVMFOMXEncNode::SetMP4EncoderParameters()
{
	...
	//Since this branch is dedicated for Aeneas product, msm7627, do not check the device name here.
    //if (strcmp("msm7627_surf", value) == 0 || strcmp("one_touch_909B_cdma", value) == 0)
    {
