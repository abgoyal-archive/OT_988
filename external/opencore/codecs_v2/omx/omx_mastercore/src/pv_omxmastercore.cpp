...

{
    ...
    if (data)
    {
        ...
        if (pInterface)
        {
            ...
            OMX_U32 index = pOMXMasterRegistry[ii].OMXCoreIndex;
			//[CTS] PR 173071 jingang.yi@jrdcom.com 2011-10-11 begin 
			//[CTS][testRTSP_H264Base_AAC_Video1/2] can passed after adding the mpeg4 and avc decoder. 
			// lack of them opencore will not get the right size between 480 and 176.
